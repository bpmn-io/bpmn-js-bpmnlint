...
import CachedResolver from './CachedResolver';
...
Linting.prototype.createElementIssues = function(elementId, elementIssues) {
  ...
  // TODO: change this once bpmnlint#3 is fixed
  var isProcess = elementId === 'Process';
...
Linting.prototype.lint = function() {
  ...
  var config = LINTER_CONFIG;

  return linter.lint(definitions, config);
};
